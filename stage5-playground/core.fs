...
\ And with does>, neither is constant: create a cell holding the value,
\ then give the new word the behavior "fetch it". This is THE example of
\ create/does> — a defining word, defined in Forth.
